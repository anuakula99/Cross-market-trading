...
class TradingEnv_cr(gymnasium.Env):
    # ... existing code ...
    
    def __init__(self, market_data, risk_free_rate=0.0):
        super(TradingEnv_cr, self).__init__()
    ...
    def step(self, action):
        ...
        # Combined reward with 80-20 weightage
        reward = 0.8 * profitability_reward + 0.2 * sharpe_ratio_reward
        reward = reward * 10
